                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: _isLoading
                                ? SizedBox(width: 24, height: 24, child: CircularProgressIndicator(color: context.textColor, strokeWidth: 2))
                                : Text('Sign Up', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: context.textColor)),
                          ),
                        ),
                      ],
                    ),
