...
class _MarketplaceScreenState extends State<MarketplaceScreen> {
  ...
  Future<List<Product>> fetchProducts() async {
    try {
      ...
      if (_minPriceController.text.isNotEmpty) {
        queryParams['min_price'] = _minPriceController.text.replaceAll(
          RegExp(r'[^0-9]'),
          '',
        );
      }
      if (_maxPriceController.text.isNotEmpty) {
        queryParams['max_price'] = _maxPriceController.text.replaceAll(
          RegExp(r'[^0-9]'),
          '',
        );
      }
      ...
      final uri = Uri.http('127.0.0.1:8000', '/products', queryParams);
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "120 pts",
                        style: TextStyle(color: Color(0xFFE67E22), fontSize: 10),
                      ),
                    ],
                  ),
                  const SizedBox(width: 8),
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: _jabodetabekCampuses.map<DropdownMenuItem<String>>((
                  String value,
                ) {
                  return DropdownMenuItem<String>(
                    value: value,
  ...
  Widget _buildProductCard(Product product) {
    String tag1 = product.tags.isNotEmpty
        ? product.tags[0]
