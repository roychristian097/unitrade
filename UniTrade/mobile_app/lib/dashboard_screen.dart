          ...
          title: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.auto_awesome, color: context.colors.textPrimary, size: 20),
              ),
              SizedBox(width: 8),
              Text("Uni", style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 20)),
              Text("Trade", style: TextStyle(color: context.colors.primary, fontWeight: FontWeight.bold, fontSize: 20)),
            ],
          ),
          actions: [
